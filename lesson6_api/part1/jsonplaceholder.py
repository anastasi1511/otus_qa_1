...
class Jsonplaceholder:
    ...
    def delete_data(self, add_url):
        response = self.session.delete(f'{self.url}{add_url}')
        return response

    def filter_data(self, param):
        response = self.session.get(f"{self.url}/posts", params=param)
        return response